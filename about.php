...
<div style="max-width:900px;margin:60px auto;padding:0 20px;text-align:center;">
    <h1 style="font-family:'Playfair Display',serif;font-size:2.5rem;color:#6c63ff;margin-bottom:16px;">
        About TechStore
    </h1>
    ...
    <div style="background:#f5f5f5;border-radius:16px;padding:40px;">
        ...
        <div style="display:flex;justify-content:center;gap:40px;">
            <div>
                <div style="width:80px;height:80px;background:#6c63ff;border-radius:50%;margin:0 auto 12px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:1.5rem;">A</div>
                <h4>Asim Sultan</h4>
